...
![图片](https://cdn.nlark.com/yuque/0/2024/jpeg/22382307/1730650933403-b2dd5071-5cab-4fdb-9477-ffe4387edfdc.jpeg)
...
**Channel 把****锁封装在了队列写入和读取****的小块区域内，然后把读者和写者完全分离**，使得读者读取数据和写者写入数据，对开发者而言，除了潜在的上下文切换外，完全和锁无关，就像访问一个本地队列一样。所以，对于大部分并发问题，我们都可以用 Channel 或者类似的思想来处理（比如 actor model）。
...
![图片](https://cdn.nlark.com/yuque/0/2024/jpeg/22382307/1730650929368-4ea4f0c5-13d1-4b18-8fd9-3637367b5b4c.jpeg)
...
![图片](https://cdn.nlark.com/yuque/0/2024/jpeg/22382307/1730650931877-afe88704-584e-4806-8656-31640b5f1bb0.jpeg)
