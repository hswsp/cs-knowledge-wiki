---
source: https://www.yuque.com/yangguangfanxing/zuyi8o/icmf8iz25inkmg34
---

# Argon2

> 原文链接：[https://www.yuque.com/yangguangfanxing/zuyi8o/icmf8iz25inkmg34](https://www.yuque.com/yangguangfanxing/zuyi8o/icmf8iz25inkmg34)
...
Run the above code example:<https://repl.it/@nakov/Argon2-in-Python>.
...
Try to **execute the above code several times** to ensure that the **<u>derived key</u>** <u>will be the same (because the salt is fixed) and the derived</u> **<u>argon2 hash</u>** <u>will be different at each execution</u> (because a random salt is generated internally by the algorithm).
