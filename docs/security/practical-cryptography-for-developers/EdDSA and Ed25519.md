---
source: https://www.yuque.com/yangguangfanxing/zuyi8o/hfglaguv1exubq58
---

# EdDSA and Ed25519

> 原文链接：[https://www.yuque.com/yangguangfanxing/zuyi8o/hfglaguv1exubq58](https://www.yuque.com/yangguangfanxing/zuyi8o/hfglaguv1exubq58)
...
The **Ed448 key pair** is generated randomly. According to [RFC 8032](https://tools.ietf.org/html/rfc8032#page-19) the Ed448 **private key** is generated from 57-byte random seed, which is transformed to 57-byte **public key** using the `SHAKE256(x, hash_len=114)` hash function, along with EC point multiplication and the special key encoding rules for Ed448.
