---
source: https://www.yuque.com/yangguangfanxing/zuyi8o/wf5ymnbay35hv66u
---

# Proof-of-Work Hash Functions

> 原文链接：[https://www.yuque.com/yangguangfanxing/zuyi8o/wf5ymnbay35hv66u](https://www.yuque.com/yangguangfanxing/zuyi8o/wf5ymnbay35hv66u)
...
-   Solves the "**Generalized Birthday Problem**" over the generated hash dataset (<u>pick 512 different strings from 2097152, such that the binary XOR of them is zero</u>). The best known solution (**Wagner's algorithm**) runs in exponential time, so it requires a lot of memory-intensive and computing-intensive calculations.
