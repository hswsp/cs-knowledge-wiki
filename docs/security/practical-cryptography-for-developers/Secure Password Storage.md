---
source: https://www.yuque.com/yangguangfanxing/zuyi8o/cztlyv5tbg8rofhk
---

# Secure Password Storage

> 原文链接：[https://www.yuque.com/yangguangfanxing/zuyi8o/cztlyv5tbg8rofhk](https://www.yuque.com/yangguangfanxing/zuyi8o/cztlyv5tbg8rofhk)
...
-   Search in Internet for [freedictionaries/ wordlists for dictionary attack](https://www.google.com/search?q=password+cracking+dictionary+download).
...
Using a **secure password storage** is only one of the components of the process of **secure password-based authentication** for Web apps, mobile a​pps and Internet services. Systems, that use password-based-authentication are subject of many attacks:
