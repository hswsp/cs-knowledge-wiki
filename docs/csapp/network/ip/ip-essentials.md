---
title: "IP 基础知识全家桶"
description: "IPv4/IPv6、子网、CIDR、NAT、路由协议总览。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/0a4cde0213e1-1.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/8859904bc36d-2.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/e43f15825241-3.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/ce98562f552a-4.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/2e42da920900-5.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/8c45e5629835-6.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/2d78c8ef3f2f-7.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/de250f046805-8.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/16646409f588-9.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/8be2ad6ae2ab-10.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/4393c9b45bc6-11.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/74777214aa3a-12.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/91bbb9210ea5-13.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/a2f224f72baf-14.jpg)
...
正因为 IP 分类存在许多缺点，所以后面提出了无分类地址的方案，即 `CIDR`（**Classless Inter-Domain Routing**，无类域间路由）。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/a850a3d554cb-15.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/5df74b5d6920-16.jpg)
...
因为**两台计算机要通讯，首先要判断是否处于同一个广播域内，即网络地址是否相同**。如果网络地址相同，表明接受方在本网络上，那么可以把数据包直接发送到目标主机。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/0528c05c8168-17.jpg)
...
**子网划分实际上是将**主机地址**分为两个部分：****子网网络地址****和子网主机地址**。形式如下：



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/3908b837257b-18.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/1d1c6658493a-19.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/f100b564fda1-20.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/90ef309b1c23-21.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/f8ec4267c11c-22.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/949adcb33011-23.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/f7b29a186b70-24.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/44e8c890a1ce-25.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/f64a061594f9-26.jpg)
...
+ **IPv6 可自动配置**，即使没有 DHCP(Dynamic Host Configuration Protocol) 服务器也可以实现自动分配IP地址，真是**便捷到即插即用**啊。
+ IPv6 包头包首部长度采用**固定的值 **`**40**`** 字节**，去掉了包头校验和，简化了首部结构，减轻了路由器负荷，大大**提高了传输的性能**。
...
**IPv6 地址长度是 128 位，是以****每 16 位作为一组（一共8组）****，每组用冒号 「:」 隔开**。



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/e5adee9bb938-27.jpg)



如果出现**连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开**。但是，一个 IP 地址中只允许出现一次两个连续的冒号。



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/9ceaf46ff7be-28.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/191ac47b5391-29.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/ddf65ec3e242-30.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/f3185f4b4172-31.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/82ac6d080ee5-32.jpg)
...
2. 本地域名服务器收到客户端的请求后，如果缓存里的表格能找到 www.server.com，则它直接返回 IP 地址。如果没有，本地 DNS 会去问它的**根域名**服务器：“老大， 能告诉我 www.server.com 的 IP 地址吗？” 根域名服务器是最高层次的，它不直接用于域名解析，但能指明一条道路。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/ab0c35df6fb3-33.jpg)
...
由于主机的路由表中可以找到下一跳的 IP 地址，所以可以通过 **ARP(Address Resolution Protocol) 协议**，求得下一跳的 MAC 地址。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/a97e7833d910-34.jpg)
...
ARP 协议是已知 IP 地址求 MAC 地址，那 **RARP 协议**正好相反，它是**已知 MAC 地址求 IP 地址**。例如将打印机服务器等小型嵌入式设备接入到网络时就经常会用得到。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/94afa1bed479-35.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/c5c447123ae2-36.jpg)
...
+ 客户端收到一个或多个服务器的 DHCP 提供报文后，从中**选择一个服务器**，并向选中的服务器发送 **DHCP 请求报文（****DHCP REQUEST****）**进行响应，回显配置的参数。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/2dec6e7d2a81-37.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/c5e58c4ca838-38.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/d619ba19d05f-39.jpg)
...
NAT 穿越技术拥有这样的功能，它能够让网络应用程序主动发现自己位于 NAT 设备之后，并且会**主动获得 NAT 设备的公有 IP**，并为自己建立端口映射条目，注意这些都是 NAT设备后的**应用程序自动完成的**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/1a8600a37e67-40.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/3096d182b562-41.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/432983483b33-42.jpg)
...
接下来，以 `IGMPv2` 作为例子，说说**常规查询与响应****和离开组播组**这两个工作机制。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/6a8cf32e26e3-43.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/31f025f2257b-44.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/ip/d706f0c29ede-45.jpg)
