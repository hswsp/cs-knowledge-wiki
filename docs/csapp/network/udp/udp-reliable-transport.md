...
description: "在 UDP 之上做 ACK/重传/拥塞控制，从 KCP 到 QUIC。"
---
...
在之前这篇文章：[TCP 就没什么缺陷吗？ ](https://www.yuque.com/yangguangfanxing/rrzw64/ffvqcp)，我已经说了 TCP 协议四个方面的缺陷：
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/48c8d2286d84-605d1026df934f20a5ee12f3c55aa6a7.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/0fa18d559452-ab3283383013b707d1420b6b4cb8517c.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/1e6dfb6a2941-http3-over-quic-protocol-works.png)
...
Packet Header 首次建立连接时和日常传输数据时使用的 Header 是不同的。如下图（_注意我没有把 Header 所有字段都画出来，只是画出了重要的字段_）：



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/1a16a7171b14-bcf3ccb6a15c4cdebe1cd0527fdd9a5e.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/e8c21c68bbd1-635813465fbb449882da2e2bee39f24e.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/a9b40465ec84-7e4e778413c1452bb6d58ec3d5452316.png)
...
这样的话，客户端就无法判断出是「原始报文的响应」还是「重传报文的响应」，这样在**计算 RTT（往返时间） 时**应该选择从发送原始报文开始计算，还是重传原始报文开始计算呢？
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/3cb5ec119a2d-ca91985c9a94487a8a29db1249109717.png)
...
另外，还有一个好处，**QUIC 使用的 ****Packet Number 单调递增****的设计，可以让数据包不再像 TCP 那样必须有序确认，****QUIC 支持乱序确认****，当数据包Packet N 丢失后，****只要有新的已接收数据包确认，当前窗口就会继续向右****滑动**（后面讲流量控制的时候，会举例子）。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/2e04789b7b13-6a94d41ef3d14cb6b7846e73da6c3104.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/47d397d46f13-536298d2c54a43b699026bffe0f85010.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/f766edd76d56-Packet_E4_B8_A2_E5_A4_B1.jpeg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/168c83ec3378-17.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/373d11423d6c-18.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/e2f184328a75-ack_E4_B8_A2_E5_A4_B1.jpeg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/6630b9b2752c-20.jpg)



接收窗口什么时候才能滑动？当接收窗口收到有序数据时，接收窗口才能往前滑动，然后那些已经接收并且**被确认的「有序」数据就可以被应用层读取**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/43d7b2d896d6-stream2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/c0b7db91edd9-http2_E9_98_BB_E5_A1_9E.jpeg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/7a926639996f-quic_E6_97_A0_E9_98_BB_E5_A1_9E.jpeg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/8e1302b6caec-f1070a6eccd24559904815297b07f789.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/dec17af08075-77e9a7cf70da4a1b981f61e78db2ad56.png)
...
_PS：但是你要问我这么设计有什么好处？我也暂时没想到，因为资料太少了，至今没找到一个合理的说明，如果你知道，欢迎告诉我啊！_
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/8d9037676c52-bbde0c66088f439b919a6d18b389aadb.png)



当图中的绿色部分数据超过**最大接收窗口的一半**后，最大接收窗口向右移动，接收窗口的右边界也向右扩展，同时给对端发送「窗口更新帧」，当发送方收到接收方的窗口更新帧后，发送窗口的右边界也会往右扩展，以此达到窗口滑动的效果。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/8862a48d2797-_E4_B9_B1_E5_BA_8F_E7_A1_AE_E8_AE_A41.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/50878ffbc44b-_E4_B9_B1_E5_BA_8F_E7_A1_AE_E8_AE_A42.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/c88070843fa4-_E4_B9_B1_E5_BA_8F_E7_A1_AE_E8_AE_A43.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/2fc8924c7e22-_E4_B9_B1_E5_BA_8F_E7_A1_AE_E8_AE_A44.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/0c245350d476-_E4_B9_B1_E5_BA_8F_E7_A1_AE_E8_AE_A45.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/171bef7a21a1-839501cffa7146cbb8d992264594e61d.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/e9949c46e2b1-4cad213f5125432693e0e2a512c2d1a1.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/udp/f0afe5a8c7e4-format_png.png)
...
+ [https://www.taohui.tech/2021/02/04/网络协议/深入剖析HTTP3协议/](https://www.taohui.tech/2021/02/04/%E7%BD%91%E7%BB%9C%E5%8D%8F%E8%AE%AE/%E6%B7%B1%E5%85%A5%E5%89%96%E6%9E%90HTTP3%E5%8D%8F%E8%AE%AE/)
