---
title: "HTTP/1.1 如何优化？"
description: "减少请求次数、缓存、连接复用与压缩等手段。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/c1f390eb5e18-_E4_BC_98_E5_8C_96http1.1_E6_8F_90_E7_BA_B2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/2311b91c209b-_E7_BC_93_E5_AD_98_E8_AE_BF_E9_97_AE.png)
...
只需要客户端在重新发送请求时，在请求的 `Etag` 头部带上**第一次**请求的响应头部中的摘要，这个摘要是唯一标识响应的资源，当服务器收到请求后，会将本地资源的摘要与请求中的摘要做个比较。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/54189ddfed0f-_E5_AE_A2_E6_88_B7_E7_AB_AF_E9_87_8D_E5_AE_9A_E5_90_91.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/f01fe960c716-_E4_BB_A3_E7_90_86_E6_9C_8D_E5_8A_A1_E5_99_A8_E9_87_8D_E5_AE_9A_E5_90_91.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/521f114d4c88-_E4_BB_A3_E7_90_86_E6_9C_8D_E5_8A_A1_E5_99_A8_E9_87_8D_E5_AE_9A_E5_90_912.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/117e49241caf-_E9_87_8D_E5_AE_9A_E5_90_91_E5_93_8D_E5_BA_94_E7_A0_81.png)
...
另外由于 HTTP/1.1 是请求响应模型，如果第一个发送的请求，未收到对应的响应，那么后续的请求就不会发送，于是为了防止单个请求的阻塞，所以一般浏览器会同时发起 5-6 个请求，每一个请求都是不同的 TCP 连接，那么如果合并了请求，也就会**减少 TCP 连接的数量，因而****省去了 TCP 握手和慢启动过程****耗费的时间**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/fd4af6db0670-css_E7_B2_BE_E7_81_B5.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/1e8a91bf38d4-base64_E5_9B_BE_E7_89_87.png)
...
有损压缩主要将次要的数据舍弃，牺牲一些质量来减少数据量、提高压缩比，这种方法经常用于**压缩多媒体数据**，比如音频、视频、图片。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/a6746936e99c-webp_E4_B8_8Epng.png)
