---
title: "HTTP/2 详解"
description: "二进制分帧、多路复用、Server Push、HPACK 头压缩。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/f340cae55e29-http2_E6_8F_90_E7_BA_B2.png)
...
+ _队头阻塞__问题_，同一连接只能在完成一个 HTTP 事务（请求和响应）后，才能处理下一个事务；
...
为了解决 HTTP/1.1 性能问题，具体的优化手段你可以看这篇文章「[HTTP/1.1如何优化？ ](https://www.yuque.com/yangguangfanxing/rrzw64/ox2cas)」，这里我举例几个常见的优化手段：
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/be16e65a0517-_E9_9D_99_E6_80_81_E8_A1_A8.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/6ef63a3ca4f1-_E9_9D_99_E6_80_81_E7_BC_96_E7_A0_81.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/662fa5232455-_E9_9D_99_E6_80_81_E5_A4_B4_E9_83_A8.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/993469ec1c82-nghttpx.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/96c52930f379-nghttpx2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/cff12fd1b7d3-_E9_9D_99_E6_80_81_E5_A4_B4_E9_83_A82.png)
...
所以，使得动态表生效有一个前提：**必须****同一个****连接上，重复传输完全相同的 HTTP 头部**。如果消息字段在 1 个连接上只发送了 1 次，或者重复传输时，字段总是略有变化，动态表就无法被充分利用了。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/53a82136ee26-_E5_A4_B4_E9_83_A8_E7_BC_96_E7_A0_81.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/8e33c7cbe2aa-_E4_BA_8C_E8_BF_9B_E5_88_B6_E5_B8_A7.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/ee2d76df2975-_E5_B8_A7_E6_A0_BC_E5_BC_8F.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/5e6e691a433d-_E5_B8_A7_E7_B1_BB_E5_9E_8B.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/80a25c373097-stream.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/43d7b2d896d6-stream2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/6aa3e9a3839f-push.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/d0907ddd97bc-push2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/b39e737dea37-27-HTTP3.png)

---

# 参考资料
1. [https://developers.google.com/web/fundamentals/performance/http2](https://developers.google.com/web/fundamentals/performance/http2)
2. [https://http2.akamai.com/demo](https://http2.akamai.com/demo)
3. [https://tools.ietf.org/html/rfc7541](https://tools.ietf.org/html/rfc7541)
