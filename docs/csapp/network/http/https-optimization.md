---
title: "HTTPS 如何优化？"
description: "会话复用、OCSP Stapling、TLS1.3 等性能优化点。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/ec16f1cdcd55-_E4_BC_98_E5_8C_96https_E6_8F_90_E7_BA_B2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/b36c6e521e25-tls_E6_80_A7_E8_83_BD_E6_8D_9F_E8_80_97.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/a207c75b0a3d-_E5_85_85_E9_92_B1.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/a8b3d644436d-aesni_intel.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/bfa03caab3b6-ssl_ecdh_curve.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/fea95be8ab4f-ssl_ciphers.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/015637eeacd1-tls1.2and1.3.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/1c60f57a77a0-crl.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/c68efb38e6bc-ocsp.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/ba0170f754be-opscp-stapling.png)
...
Session ID 的工作原理是，**客户端和服务器首次 TLS 握手连接后，双方会在内存缓存会话密钥，并用****唯一的 Session ID**** 来标识**，Session ID 和会话密钥相当于 key-value 的关系。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/6904af667298-sessionid.png)
...
为了解决 Session ID 的问题，就出现了 Session Ticket，**服务器不再缓存每个客户端的会话密钥，而是把****缓存的工作交给了客户端**，类似于 HTTP 的 Cookie。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/c7e9c967fa03-ticket.png)



对于集群服务器的话，**要****确保每台服务器加密 「会话密钥」****的密钥是一致的**，这样客户端携带 Ticket 访问任意一台服务器时，都能恢复会话。



Session ID 和 Session Ticket **都****不具备前向安全性**，因为一旦加密「会话密钥」的密钥被破解或者服务器泄漏「会话密钥」，前面劫持的通信密文都会被破解。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/aa14c00d2d01-_E9_87_8D_E6_94_BE_E6_94_BB_E5_87_BB.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/c9e09041b35c-0-RTT.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/http/7ac82e1c88a8-0-rtt-attack.png)
