---
title: "TCP 是如何避免历史报文的？"
description: "ISN 随机化、PAWS 时间戳与端口复用安全。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a80530623e5e-ed84bb4aa742a33f50d8035da2867ca2.png)
...
**为了解决这个问题，就需要有 TCP 时间戳**。tcp_timestamps 参数是默认开启的，开启了 tcp_timestamps 参数，TCP 头部就会使用时间戳选项，它有两个好处，**一个是便于精确计算 RTT ，另一个是能防止****序列号回绕****（PAWS）**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7bd7e17ae4e9-1d497c38621ebc44ee3d8763fd03da67.png)
