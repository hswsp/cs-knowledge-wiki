---
title: "原来墙，是这么把我 TCP 连接干掉的！"
description: "防火墙/中间盒如何用 RST、SYN 阻断 TCP 连接。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a615a1fc3000-640.jpg)from 维基百科



我们的墙，在过滤网站的时候，其实就是这么干的。当然，墙除了 TCP 重置连接的方式外，还有很多方式来过滤网站，比如**域名劫持、IP封锁、HTTPS 证书过滤等等**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/30e56ea91c9f-640.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/78916bc0352a-640.jpg)模拟一个 TCP 服务端
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f8283ae911da-640.jpg)客户端连接服务端
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/8e86b501db16-640.jpg)TCP 连接的四元组信息
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7173edcae1cf-640.jpg)执行 tcpkill
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/8e86b501db16-640.jpg)TCP 连接还存在
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/41e4a984342e-640.jpg)客户端断开了
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/007d30a3487d-640.jpg)刚才那条 TCP 连接已经不存在
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7f42f5242a09-640.jpg)tcpkill 工具输出的信息



可以看到， **tcpkill 工具****给服务端和客户端都发送了伪造的 RST 报文****，从而达到关闭一条 TCP 连接的效果**。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/de5358bc2c81-640.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/1fd2e0928754-640.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f53497c3d237-640.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/c23d51b64d25-640.jpg)
