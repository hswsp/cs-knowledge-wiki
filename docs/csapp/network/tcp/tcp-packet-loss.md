---
title: "TCP 协议丢包的场景"
description: "超时重传、快速重传、SACK 与丢包原因诊断。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/eb78eef76e58-1d0a1d60ca4f720423911cf8f25c4ac3.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/6f03f18c23db-7e8bae365b8d27560aac1cd28f501156.png)
...
一个数据包，从聊天框里发出，消息会从**聊天软件**所在的**用户空间**拷贝到**内核空间**的**发送缓冲区（send buffer）**，数据包就这样顺着**传输层、网络层，进入到数据链路层，在这里数据包会经过****流控（qdisc）****，再通过****RingBuffer****发到物理层的网卡**。数据就这样顺着**网卡**发到了**纷繁复杂**的网络世界里。这里头数据会经过n多个**路由器和交换机**之间的跳转，最后到达**目的机器的网卡**处。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/750fba0024a4-28e4d6b004530fbf75fe346d181baa81.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/46eab3c31a30-923f5005edb536c0d07b096bbf2ca282.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/e95cb191aee5-02a78bb83fe167324f26e8c910d7a7a2.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/1a6864becaf6-591d630098b4fc5316a5005f1e94b844.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f22a1b09bb25-6f2821018be08a2f27561155e8085de4.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/06f98cdab893-8f3ed2d6c4e2e154849f1e661528fe89.png)
...
我们可以通过`ethtool`加网卡名，获得当前网卡支持的最大速度。(MacOS下使用`ifconfig <interfaceName> | grep media`)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/dbf928d6d344-9cd22437777205662048c73cc5855add.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/e0a805d6f313-7312e536393463dcf0d57aeb07f28ed5.gif)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f7676c2599d4-f378a299ca60c490ee5437e1143916c8.gif)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/777a965a88ff-2df66c2e1d9f1245813e8d1de7482e0c.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/4bc9a0e87103-56bdca9995c0c2a343b2b73b67933b78.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a7bcc3c1453c-4a2d8dbfb648bcced864fb653af9f036.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/423be293b040-0650adc524ab7d82028dc83cfc9961e1.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f1f035495cb3-7142a4e285024dc6aadea4255984c485.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/1cde9f27637f-b2225e071fec7cfb240aa295ed4037bf.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a5a5c80665f1-c1460d52efe7c5e4d80c2f7160d5b126.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/4f20c43102b3-c6794dd51c8780f12e4022fc964ebb0a.png)
...
**聊天软件还****需要将数据从TCP的接收缓冲区里读出来****，如果在读出来这一刻，手机由于内存不足或其他各种原因，导致软件崩溃闪退了。**
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/110cd827d9ce-9286ab84bcaa74576bc11c8e9322fee9.png)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/390ca3447c91-d53659df39d64db4780d2816bd8314d1.png)
