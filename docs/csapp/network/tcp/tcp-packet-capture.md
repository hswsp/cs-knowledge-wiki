---
title: "TCP 实战抓包分析"
description: "通过 wireshark 抓包剖析 TCP 报文与状态变化。"
---
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7d5dbc0278f7-2.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/09eb4cdb3bef-3.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f20aef83baae-4.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/98405d7c4500-5.jpg)



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/2c147d6b1008-6.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/962a849e8baa-7.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/70ae17a6193e-8.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/76d802d70c95-9.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/3cb2f77ba1ee-10.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/2f18fd6c35a1-11.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/d277eaa55145-12.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/15d1f0a8a6c2-13.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/3eb2382de709-14.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/327efad8ec86-15.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/70904c03c3a2-16.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/10bcfd65e3a2-17.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/33edba3cfa43-18.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7b24ac37b5b9-19.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/35fca9bb6848-20.jpg)
...
+ 那会重传几次？
+ 超时重传的时间 RTO（恢复时间目标：Recovery Time Object） 会如何变化？
+ 在 Linux 下如何设置重传次数？
+ ....
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/dae294728d79-21.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/5eb444b79ecf-22.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/0e63fd8932d8-23.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/b4950b65fdb4-24.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/30ae5104cb9a-25.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/96bb909f1362-26.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a61f02319923-27.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/ee6eefc627bf-28.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/03987db089ca-29.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/198d033e39de-30.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/71c3270776e7-31.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/84f192276370-32.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/cc645cea520a-33.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f2d6fd6065de-34.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a924efb5c2ad-35.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/7f9121a90d0f-36.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/efec807212a8-37.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/74bf70b2d646-38.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/e4e8d9afca46-39.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f73bef55f39b-40.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a1fc813e1ab0-41.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/f5005e68c369-42.jpg)
...
+ 接着，服务端超时重传了 SYN、ACK 包，重传了 5 次后，也就是**超过 tcp_synack_retries 的值（默认值是 5），然后就没有继续重传了，此时****服务端的 TCP 连接主动中止了****，所以刚才处于 SYN_RECV 状态的 TCP 连接断开了**，而客户端依然处于`ESTABLISHED` 状态；
...
TCP **建立连接后**的数据包传输，最大超时重传次数是由 `tcp_retries2` 指定，默认值是 15 次，如下：
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/a6fc84a71896-43.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/5e86d1b4ee3f-44.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/2421b27606cf-45.jpg)



+ 在第一次建立连接的时候，**服务端在第二次握手产生一个 **`**Cookie**`** （已加密）**并通过 SYN、ACK 包一起发给客户端，于是客户端就会缓存这个 `Cookie`，所以第一次发起 HTTP Get 请求的时候，还是需要 2 个 RTT 的时延；
+ 在下次请求的时候，客户端在 SYN 包带上 `Cookie` 发给服务端，就提前可以**跳过三次握手**的过程，因为 `Cookie` 中维护了一些信息，服务端可以从 `Cookie` 获取 TCP 相关的信息，这时发起的 HTTP GET 请求就只需要 1 个 RTT 的时延；
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/cd199ced8e6a-46.jpg)
...
当接收方收到乱序数据包时，会发送重复的 ACK，以便告知发送方要重发该数据包，**当****发送方收到 3 个重复 ACK 时，就会触发快速重传****，立刻重发丢失数据包。**



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/4f33b58ee7a3-47.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/ab5388605bca-48.jpg)
...
TCP 为了防止发送方无脑的发送数据，导致接**收方缓冲区被填满**，所以就有了滑动窗口的机制，它可利用接收方的接收窗口来控制发送方要发送的数据量，也就是流量控制。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/ec3d7ce47d37-49.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/5b539bc9614e-50.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/817aaa9926da-51.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/9ef8b83cfdd1-52.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/d2e3c063763c-53.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/3f50037a79eb-54.jpg)
...
很遗憾，没有简单的办法，发送窗口虽然是由接收窗口决定，但是它又可以被网络因素影响，也就是拥塞窗口，实际上**发送窗口是值是 **`**min(拥塞窗口，接收窗口)**`。
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/9fe655464016-55.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/9deb424d4f2e-56.jpg)
...
+ 当没有响应数据要发送时，ACK 将会延迟**一段**时间，以等待是否有**响应数据可以一起发送**
+ 如果在延迟等待发送 ACK 期间，对方的第二个数据报文又到达了，这时就会立刻发送 ACK



![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/d467cff09bca-57.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/455dd0c6e9ae-58.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/b1d2493fa407-59.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/6a91e42be5a0-60.jpg)
...
![](https://images.spumn.eu.cc/cs-knowledge-wiki/csapp/network/tcp/0606217edc14-61.jpg)
