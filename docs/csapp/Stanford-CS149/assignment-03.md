---
title: "Assignment 3: A Circle Renderer in CUDA"
---

# Assignment 3: A Simple CUDA Renderer

![My Image](https://images.spumn.eu.cc/Stanford-CS149/assignments/asst3/teaser.jpg)
...
![Ordering](https://images.spumn.eu.cc/Stanford-CS149/assignments/asst3/order.jpg "The renderer must be careful to generate output that is the same as what is generated when sequentially drawing all circles in the order provided by the application.")
...
![Dependencies](https://images.spumn.eu.cc/Stanford-CS149/assignments/asst3/dependencies.jpg "The contributions of circles 1, 2, and 3 must be applied to overlapped pixels in the order the circles are provided to the renderer.")
...
![Order_errors](https://images.spumn.eu.cc/Stanford-CS149/assignments/asst3/bug_example.jpg "Errors in the output due to lack of atomicity in frame-buffer update (notice streaks in bottom of image).")
