...
> 来源：[https://learn.shareai.run/zh/docs/s00b-one-request-lifecycle/](https://learn.shareai.run/zh/docs/s00b-one-request-lifecycle/)
...
-   [`s01-the-agent-loop.md`](./s01-the-agent-loop)
-   [`s00a-query-control-plane.md`](./s00a-query-control-plane)
...
-   [`s02-tool-use.md`](./s02-tool-use)
-   [`s02a-tool-control-plane.md`](./s02a-tool-control-plane)
...
-   [`s07-permission-system.md`](./s07-permission-system)
...
-   [`s08-hook-system.md`](./s08-hook-system)
...
-   [`s03-todo-write.md`](./s03-todo-write)
...
-   [`s12-task-system.md`](./s12-task-system)
...
-   [`s13-background-tasks.md`](./s13-background-tasks)
-   [`s13a-runtime-task-model.md`](./s13a-runtime-task-model)
...
-   [`s15-agent-teams.md`](./s15-agent-teams)
-   [`s16-team-protocols.md`](./s16-team-protocols)
-   [`s17-autonomous-agents.md`](./s17-autonomous-agents)
...
-   [`s18-worktree-task-isolation.md`](./s18-worktree-task-isolation)
...
-   [`s19-mcp-plugin.md`](./s19-mcp-plugin)
-   [`s19a-mcp-capability-layers.md`](./s19a-mcp-capability-layers)
...
-   [`s06-context-compact.md`](./s06-context-compact)
-   [`s11-error-recovery.md`](./s11-error-recovery)
