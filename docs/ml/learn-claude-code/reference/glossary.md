...
> 来源：[https://learn.shareai.run/zh/docs/glossary/](https://learn.shareai.run/zh/docs/glossary/)
...
-   先看 [`entity-map.md`](./entity-map)：搞清每个实体属于哪一层。
-   再看 [`data-structures.md`](./data-structures)：搞清这些词真正落成什么状态结构。
-   如果你卡在“任务”这个词上，再看 [`s13a-runtime-task-model.md`](./s13a-runtime-task-model)。
-   如果你卡在 MCP 不只等于 tools，再看 [`s19a-mcp-capability-layers.md`](./s19a-mcp-capability-layers)。
