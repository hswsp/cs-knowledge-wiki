...
![Dynamic KV Cache 示意图](https://images.spumn.eu.cc/aios/lesson-5/dynamic_kv_cache.svg)
...
![Preallocated KV Cache 示意图](https://images.spumn.eu.cc/aios/lesson-5/preallocated_kv_cache.svg)
...
![操作系统分页内存管理示意图](https://images.spumn.eu.cc/aios/lesson-5/os_paging_memory.svg)
...
![Paged KV Cache Prefill 流程图](https://images.spumn.eu.cc/aios/lesson-5/paged_kv_cache_prefill.svg)

![Paged KV Cache Decode 流程图](https://images.spumn.eu.cc/aios/lesson-5/paged_kv_cache_decode.svg)
...
![AIOS Paged KV 整体架构图](https://images.spumn.eu.cc/aios/lesson-5/paged_kv_architecture_aios.svg)
