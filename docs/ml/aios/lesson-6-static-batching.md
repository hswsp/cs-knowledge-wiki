...
![串行 vs 静态批：GPU 时间线对比](https://images.spumn.eu.cc/aios/lesson-6/static_batching_why.png)
...
![Scheduler/Engine/LLM 三层架构](https://images.spumn.eu.cc/aios/lesson-6/static_batching_arch.png)
...
![Lesson 6 数据结构关系图](https://images.spumn.eu.cc/aios/lesson-6/data_structures.png)
...
![TableManager 二维结构](https://images.spumn.eu.cc/aios/lesson-6/table_manager.png)
...
![Scheduler 调度流程](https://images.spumn.eu.cc/aios/lesson-6/scheduler_flow.png)
...
![Decode 变长 KV: pad + per-request mask](https://images.spumn.eu.cc/aios/lesson-6/decode_attention.png)
