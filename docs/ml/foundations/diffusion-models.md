...
- **Transformer**：可作为扩散模型的骨干网络（如 DiT），替代传统 U-Net → [详见](./transformer)
- **多模态 AI**：文本/图像/音频/视频的 tokenization 与跨模态对齐 → [详见](./multimodal-ai)
:::

> 扩散模型是当前图像、视频、音频生成的主流技术路线。本文档聚焦其核心原理和关键改进。
>
> 相关文档：[多模态 AI](./multimodal-ai) | [Transformer 架构](./transformer)
