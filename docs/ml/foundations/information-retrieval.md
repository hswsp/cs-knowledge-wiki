...
:::info 背景知识
- **词嵌入 (Embedding)**：将文本映射为高维向量，语义相近的文本在向量空间中距离近 → [详见](./representation-learning)
- **余弦相似度**：衡量两个向量之间的角度差异，不受向量长度影响，适合文本嵌入的相似度计算
- **RAG (检索增强生成)**：从外部知识库检索相关文档，注入 LLM 上下文以减少幻觉 → [详见](https://wang-x-xia.github.io/learn-ai/applied/rag/)
:::

> 信息检索是 AI 系统的核心组件——无论是搜索引擎、RAG 系统，还是 Agent 记忆系统，都需要从海量数据中快速找到相关内容。本文档聚焦检索算法的技术原理和设计权衡。
>
> 相关文档：[RAG 检索策略](https://wang-x-xia.github.io/learn-ai/applied/rag/) | [Agent 记忆系统](https://wang-x-xia.github.io/learn-ai/agent/memory-systems/)
...
![information-retrieval diagram 1](https://images.spumn.eu.cc/blog/learn-ai-information-retrieval-1-102db6b20d6973a0.svg)
