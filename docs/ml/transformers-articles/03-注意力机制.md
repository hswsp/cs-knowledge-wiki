...
![](https://images.spumn.eu.cc/assets/img/attention/transformer.jpeg)

图 3-3 标准 Transformer 模型

其中，编码器和解码器都各自包含有多层构件（building blocks）。图 3-4 展示了一个翻译任务的例子：

![](https://images.spumn.eu.cc/assets/img/attention/encoder_decoder_architecture.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/arrangements_of_layer_normalization.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/transformer_decoder.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/local_attention_mask.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/sliding_window_attention.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/mha_mqa_gqa.png)
...
![](https://images.spumn.eu.cc/assets/img/attention/mixture_of_experts.png)
