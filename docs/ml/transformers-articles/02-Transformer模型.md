...
![](https://images.spumn.eu.cc/assets/img/transformers/transformers_chrono.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/causal_modeling.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/masked_modeling.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/nlp_models_size.png)

图 2-4 Transformer 模型规模的变化趋势

但是，从头训练一个预训练语言模型，尤其是大型语言模型，需要海量的数据，不仅时间和计算成本非常高，对环境的影响也很大，如图 2-5 所示：

![](https://images.spumn.eu.cc/assets/img/transformers/carbon_footprint.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/pretraining.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/finetuning.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/transformers_blocks.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/transformers.svg)
...
![](https://images.spumn.eu.cc/assets/img/transformers/transformers_architecture.png)
...
![](https://images.spumn.eu.cc/assets/img/transformers/AttentionSceneFinal.gif)
...
![](https://images.spumn.eu.cc/assets/img/transformers/token_selection.png)
...
![](https://images.spumn.eu.cc/assets/img/transformers/repeat_penalty.png)
...
![](https://images.spumn.eu.cc/assets/img/transformers/beam_search.png)
