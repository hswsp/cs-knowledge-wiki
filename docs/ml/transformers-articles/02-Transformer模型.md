...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/transformers_chrono.svg" alt=""></p>

<p align="center">图 2-1 具有代表性的 Transformer 模型</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/nlp_models_size.png" alt=""></p>

<p align="center">图 2-4 Transformer 模型规模的变化趋势</p>

但是，从头训练一个预训练语言模型，尤其是大型语言模型，需要海量的数据，不仅时间和计算成本非常高，对环境的影响也很大，如图 2-5 所示：

<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/carbon_footprint.svg" alt=""></p>

<p align="center">图 2-5 各种人类活动的碳排放对比</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/pretraining.svg" alt=""></p>

<p align="center">图 2-6 预训练语言模型过程示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/finetuning.svg" alt=""></p>

<p align="center">图 2-7 微调语言模型过程示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/transformers_blocks.svg" alt=""></p>

<p align="center">图 2-8 微调语言模型过程示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/transformers.svg" alt=""></p>

<p align="center">图 2-9 Transformer 模型结构</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/transformers_architecture.png" alt=""></p>

<p align="center">图 2-10 Transformer 架构</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/AttentionSceneFinal.gif" alt=""></p>

<p align="center">图 2-11 注意力机制工作示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/token_selection.png" alt=""></p>

<p align="center">图 2-12 词元选择示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/repeat_penalty.png" alt=""></p>

<p align="center">图 2-13 词元选择示意图</p>
...
<p align="center"><img src="https://images.spumn.eu.cc/assets/img/transformers/beam_search.png" alt=""></p>

<p align="center">图 2-14 束搜索示意图</p>
