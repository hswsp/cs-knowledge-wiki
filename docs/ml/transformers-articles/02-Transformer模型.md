...
![transformers_chrono](https://images.spumn.eu.cc/assets/img/transformers/transformers_chrono.svg)
...
![causal_modeling](https://images.spumn.eu.cc/assets/img/transformers/causal_modeling.svg)

图 2-2 因果语言建模示意图
  * 基于上下文，即周围的词语，来预测句子中被遮盖掉的词语（Masked Word），因此该任务被称为**遮盖语言建模** （Masked Language Modeling，MLM），如图 2-3 所示。

![masked_modeling](https://images.spumn.eu.cc/assets/img/transformers/masked_modeling.svg)
...
![nlp_models_size](https://images.spumn.eu.cc/assets/img/transformers/nlp_models_size.png)

图 2-4 Transformer 模型规模的变化趋势

但是，从头训练一个预训练语言模型，尤其是大型语言模型，需要海量的数据，不仅时间和计算成本非常高，对环境的影响也很大，如图 2-5 所示：

![carbon_footprint](https://images.spumn.eu.cc/assets/img/transformers/carbon_footprint.svg)
...
![pretraining](https://images.spumn.eu.cc/assets/img/transformers/pretraining.svg)
...
![finetuning](https://images.spumn.eu.cc/assets/img/transformers/finetuning.svg)
...
![transformers_blocks](https://images.spumn.eu.cc/assets/img/transformers/transformers_blocks.svg)
...
![transformers](https://images.spumn.eu.cc/assets/img/transformers/transformers.svg)
...
![transformers_architecture](https://images.spumn.eu.cc/assets/img/transformers/transformers_architecture.png)
...
![transformers_architecture](https://images.spumn.eu.cc/assets/img/transformers/AttentionSceneFinal.gif)
...
![transformers_architecture](https://images.spumn.eu.cc/assets/img/transformers/token_selection.png)
...
![transformers_architecture](https://images.spumn.eu.cc/assets/img/transformers/repeat_penalty.png)
...
![transformers_architecture](https://images.spumn.eu.cc/assets/img/transformers/beam_search.png)
