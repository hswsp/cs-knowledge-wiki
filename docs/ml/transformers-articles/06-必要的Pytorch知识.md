...
[code] >     from torch.utils.data import IterableDataset, DataLoader
>     
...
>     
```
[code] >     [tensor([3]), tensor([4]), tensor([5]), tensor([6])]
>     
...
[code] >     from torch.utils.data import get_worker_info
>     
...
>     
```
[code] >     [tensor([3]), tensor([5]), tensor([4]), tensor([6])]
>     
