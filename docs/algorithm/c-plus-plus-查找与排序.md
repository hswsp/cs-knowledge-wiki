---
title: "C++ 查找与排序"
description: "查找函数STL find()find() 函数本质上是一个模板函数，用于在指定范围内查找和目标元素值相等的第一个元素。如下为 find() 函数的语法格式：InputIterator find (InputIterator first, InputIterator last, const T&amp;..."
---
...
![image.png](https://cdn.nlark.com/yuque/0/2022/png/22382307/1664175857552-12b8f914-ab0c-4829-a928-05ed6ac70ca6.png)

2.`upper_bound(起始地址，结束地址，要查找的数值)` 返回大于val的第一个元素位置。返回的是数值最后一个 出现的位置。

![image.png](https://cdn.nlark.com/yuque/0/2022/png/22382307/1664175865547-8654ee76-1d53-4276-b25e-c7ffc7c268aa.png)
...
![image](https://img-blog.csdnimg.cn/d9eed921093b41a38053f162d812dc7c.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBASHVudGVyIERyZWFtZXI=,size_20,color_FFFFFF,t_70,g_se,x_16)
...
std::cout - search() 支持自定义比较函数，比如查询给定区间中每个元素比目标区间小1的子区间:
...
std::vector::iterator it = std::search (haystack.begin(), haystack.end(), needle2, needle2+3, cmpFunction);
