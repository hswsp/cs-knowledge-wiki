...
description: "参考文档：Floyd Warshall Algorithm | DP-16Floyd算法介绍和Dijkstra算法一样，弗洛伊德(Floyd)算法也是一种用于寻找给定的加权图中顶点间最短路径的算法。该算法名称以创始人之一、1978年图灵奖获得者、斯坦福大学计算机科学系教授罗伯特·弗洛伊德命名。..."
---
...
![image](https://github.com/wangkuiwu/datastructs_and_algorithm/blob/master/pictures/graph/floyd/01.jpg?raw=true)

以上图G4为例，来对弗洛伊德进行算法演示。

![image](https://github.com/wangkuiwu/datastructs_and_algorithm/blob/master/pictures/graph/floyd/02.jpg?raw=true)
...
void floydWarshall(int graph[][V])
{
	...
	for (i = 0; i  Before start of an iteration,
