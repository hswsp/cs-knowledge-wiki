...
当 $i \ge 2$时，假设对正整数 i拆分出的第一个正整数是 j（$1 \le j < i$），则有以下两种方案：
...
![image](https://images.spumn.eu.cc/blog/634b897a81b4f8b5.svg) 取对数

![image](https://images.spumn.eu.cc/blog/2f00603f8ee0fa1d.svg) 对x求导

![image](https://images.spumn.eu.cc/blog/3b617e69b98cf674.svg) 
...
![](https://images.spumn.eu.cc/blog/e38f32ba02ce3c5c.png)
