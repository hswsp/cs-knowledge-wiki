...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdFibOOvru90NjInwNskrznDWZq8Koh22aEicmAuicETsaDBA3OGQwqcKyOFNLKyICd2bv209B2uFbxibQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
`x&-x`表示取`x`最低位为1的那个数。即`m = x&-x`,则`x%m = 0`且![image](https://cdn.nlark.com/yuque/__latex/f71416a4aa5ae2fd5c5ddb3094e92a72.svg), 如果x为奇数， m =1。例如： 
