...
注意递归和状态转移方程式相反的方向。状态转移是通过$f[i-1][j-1]$推导![image](https://images.spumn.eu.cc/blog/612baf0ed28f9d4a.svg)。而递归框架是考虑![image](https://images.spumn.eu.cc/blog/3952e3877a690c5c.svg)的时候带入![image](https://images.spumn.eu.cc/blog/483a78ecac2862d1.svg)的情况。
...
![image](https://images.spumn.eu.cc/blog/612baf0ed28f9d4a.svg)**代表 A 的前 **$i$** 个和 B 的前 **$j$** 个能否匹配**
