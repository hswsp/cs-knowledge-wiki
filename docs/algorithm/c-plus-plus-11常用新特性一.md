---
title: "C++11常用新特性（一）"
description: "教程地址： https://github.com/0voice/cpp_new_features对于异步编程十分实用的Future/Promise以及智能指针等，这里不做整理介绍。nullptrnullptr 出现的目的是为了替代 NULL。在某种意义上来说，传统 C++ 会把 NULL、0 ..."
---

# C++11常用新特性（一）

教程地址： [https://github.com/0voice/cpp_new_features](https://github.com/0voice/cpp_new_features)
对于异步编程十分实用的Future/Promise以及智能指针等，这里不做整理介绍。
...
template
typedef SuckType, U, 1> NewType; // 不合法
```
...
int main()
{
    ...
    std::cout (student) (student) (student) 
