---
title: "加权沿路最小"
description: "「魔塔」是一款经典的地牢类游戏，碰怪物要掉血，吃血瓶能加血，你要收集钥匙，一层一层上楼，最后救出美丽的公主。现在手机上仍然可以玩这个游戏：嗯，相信这款游戏承包了不少人的童年回忆，记得小时候，一个人拿着游戏机玩，两三个人围在左右指手画脚，这导致玩游戏的人体验极差，而左右的人异常快乐 😂力扣第 ..."
---
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX9G068Yy8xOLr1Ulib5SAnEZWKmfG9ibicHn32Ldia3S3oqydsxXCbibfo0CA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX9PQtia65ibBx4icoXuU2epQrtfmvuzl6ia7Ll9ar0GjcNex9I2B9MJTIMpg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

算法应该返回 7，也就是说骑士的初始生命值**至少**为 7 时才能成功救出公主，行进路线如图中的箭头所示。

上篇文章 [最小路径和](https://www.yuque.com/docs/share/7f1c0584-691c-4383-8fe4-8fa634a7f778?) 写过类似的问题，问你从左上角到右下角的最小路径和是多少。
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX95IKoR9ln4brUkahmOFlticnjUUr6uY36zSxY4dssUpySux6CoFKUyPA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

但也很容易看到，正确的答案应该是下图箭头所示的路径，初始生命值只需要 1：

![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX92LdTicQz9Tq7SicxHcvG57w4Oz0mPibRCRwe5eTCF1ppXszAmxw8uv7KQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

**所以，关键不在于吃最多的血瓶，而是在于如何损失最少的生命值**。

这类求最值的问题，肯定要借助动态规划技巧，要合理设计`dp`数组/函数的定义。类比前文 [最小路径和问题](https://www.yuque.com/docs/share/7f1c0584-691c-4383-8fe4-8fa634a7f778?)，`dp`函数签名肯定长这样：
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX9jvSEkw1Q8EVeFPt6sibrhSibbPBL2U4QIeZbEbWDQ27vWZAwvYDLgib9w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX9NQV8Ml3Bx6hX8Vicn35wQ7CnjiaquMCc2nibA3F2IYIccrmdng7eWg71Q/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![image](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHUIOXk6eUGxLHdqo29uZX93pzm5elLJEbhYib6I7FpKAjQfNV2V3yADWc2M9XQlaG4iawVPWy1yfIQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
这就是自顶向下带备忘录的动态规划解法，参考前文 [动态规划套路详解](http://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247484731&idx=1&sn=f1db6dee2c8e70c42240aead9fd224e6&chksm=9bd7fb33aca07225bee0b23a911c30295e0b90f393af75eca377caa4598ffb203549e1768336&scene=21#wechat_redirect) 很容易就可以改写成`dp`数组的迭代解法，这里就不写了，读者可以尝试自己写一写。
