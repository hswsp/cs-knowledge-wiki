...
值得一提的是，这个问题可以用动态规划方法解决，时间复杂度一样，但是空间复杂度至少要 ![image](https://images.spumn.eu.cc/blog/269b75045539b398.svg) 来存储 DP table。这道题是少有的动态规划非最优解法的问题。
...
我们用 C 表示回文串的中心，用 R 表示回文串的右边半径坐标，所以 ![image](https://images.spumn.eu.cc/blog/fb845d03b12d5559.svg) 。C 和 R 所对应的回文串是当前循环中 R 最靠右的回文串。
...
空间复杂度：![image](https://images.spumn.eu.cc/blog/cf5ec3f2f47aa3bb.svg)。
