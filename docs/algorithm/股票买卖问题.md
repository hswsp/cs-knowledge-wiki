---
title: "**一、穷举框架**"
description: "这篇文章用「状态机」的技巧给出最优解，可以全部提交通过。不要觉得这个名词高大上，文学词汇而已，实际上就是 DP table，等会儿一讲就明白了。"
---
...
![](https://mmbiz.qpic.cn/mmbiz_png/map09icNxZ4nPicwNq5syrSwnBc02yxG3aTWM5qlnc1ic8rc2v4ibuquTDUWOu7GVYqFAib4iaFxekON2AqKAPnAzicNw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/map09icNxZ4nPicwNq5syrSwnBc02yxG3auom48UuPXWBQV7IRsa59yHe1TRQicDquqyRFOoia62BqHzofboyiay5IA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/map09icNxZ4kbOQM3dXVKdgSXOCibeUUK2nACKnCmYcLSOsGpvKc46tF7vzVSfIUISR0gd93cMPE9phGOZiaImlWw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/map09icNxZ4kbOQM3dXVKdgSXOCibeUUK2uibf92DLjHdyzfek9b7lfuia0mM4icmKgZB8ibJzkuxDY2e3zpzqeyUZtQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629904347086-d090de10-8e4d-4642-a774-93dff945b03d.png)
...
![](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629904288533-4b1da6df-6b8d-4b78-8a09-4f8edb5607d0.png)
...
```cpp
 int maxProfit(vector<int>& prices, int fee) {
     ...
     for(int i = 0;i<n;++i){
         ...
         dp_i1 = max(dp_i1,dp_pre1_0 - prices[i]);
     }
     return dp_i0;
 }
```
...
![](https://mmbiz.qpic.cn/mmbiz_png/map09icNxZ4nPicwNq5syrSwnBc02yxG3aAfehqTCribLX230FrJWmuZxTSAicpI7j8KWN7BMTmg7FVgdBf4tNibhaQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629903592305-ad2fcda3-cc97-4d40-88db-e3e3af5e9c62.png)
...
int maxProfitKInf(vector<int>& prices){
    ...
    int dp_i1 = INT_MIN;
    for(int i = 0;i<n;++i){
        int dp_i_minus_1_0 = dp_i0;
        dp_i0 = max(dp_i_minus_1_0,dp_i1+prices[i]);
        dp_i1 = max(dp_i_minus_1_0-prices[i],dp_i1);
    }
    return dp_i0;
}
```
