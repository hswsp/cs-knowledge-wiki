...
![](https://images.spumn.eu.cc/blog/bf64f50602245468.png)
...
+ ![](https://images.spumn.eu.cc/blog/573fd3c686b29364.png)
...
![](https://images.spumn.eu.cc/blog/03927b3d6bade9dc.png)
...
![](https://images.spumn.eu.cc/blog/3cfadbe372b10465.png)
...
![](https://images.spumn.eu.cc/blog/4c9c761b46243fec.png)
...
![](https://images.spumn.eu.cc/blog/1986deed9e52ac76.png)
...
![](https://images.spumn.eu.cc/blog/0b7713669a8abcee.png)
...
![](https://images.spumn.eu.cc/blog/e2d02714844f23fb.png)
...
我们可以通过位运算让它更加优美。因为数据量很小 $n \leq 10$，所以我们可以把每一列有没有放置皇后压缩进一个 `int cb` 中存储。同理左上 45°，右上 45° 信息也是可以压缩进 int 中 `lb` 和 `rb` 表示的，表示经过左上 45° / 右上 45° 的棋子影响后，当前行哪些位置不可以防止皇后，从这一行到下一行仅仅是一个左移 / 右移就可以变化的。
