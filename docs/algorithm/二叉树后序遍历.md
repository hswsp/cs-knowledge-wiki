---
title: "二叉树后序遍历"
description: "其实二叉树的题目真的不难，无非就是前中后序遍历框架来回倒嘛，但是对于有的题目，不同的遍历顺序时间复杂度不同。"
---
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHPS5VAZLnrULF1Eqpr8EISD3ia8Yoh1XbOo3SXibFAlHFjsWg3xkGSSLI8hxXR36zU7aCv0IABslZw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/gibkIz0MVqdHPS5VAZLnrULF1Eqpr8EISBoibU3t8ib41icmnqiak12s2icnvmm2ibQ9OHlEtsLbVyqwgD5icOWJyrQZeQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
public:
    ...
    vector<int> traverse(TreeNode* root){
        ...
        if(left[0]==1&&right[0]==1&&root->val<right[1]&&root->val>left[2]){
            res[0] = 1;
            //注意这里不能少min()，可能left[2]<root->val<left[1],也就是left对应nullptr
