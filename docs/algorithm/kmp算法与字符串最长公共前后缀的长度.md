...
![](https://pic3.zhimg.com/50/v2-2967e415f490e03a2a9400a92b185310_720w.jpg?source=1940ef5c)![](https://pic3.zhimg.com/80/v2-2967e415f490e03a2a9400a92b185310_1440w.jpg?source=1940ef5c)
...
![](https://pica.zhimg.com/50/v2-49c7168b5184cc1744459f325e426a4a_720w.jpg?source=1940ef5c)![](https://pica.zhimg.com/80/v2-49c7168b5184cc1744459f325e426a4a_1440w.jpg?source=1940ef5c)
...
![](https://pica.zhimg.com/50/v2-d6c6d433813595dce5aad08b40dc0b72_720w.jpg?source=1940ef5c)![](https://pica.zhimg.com/80/v2-d6c6d433813595dce5aad08b40dc0b72_1440w.jpg?source=1940ef5c)
...
![](https://pic3.zhimg.com/50/v2-6ddb50d021e9fa660b5add8ea225383a_720w.jpg?source=1940ef5c)![](https://pic3.zhimg.com/80/v2-6ddb50d021e9fa660b5add8ea225383a_1440w.jpg?source=1940ef5c)
...
![](https://pic3.zhimg.com/80/v2-1dda8f33e5847449cd9784e76e972cab_1440w.jpg?source=1940ef5c)



如上图代码所示，直接根据next数组的定义来建立next数组。不难发现它的复杂度是 ![](https://www.zhihu.com/equation?tex=O%28m%5E2%29) 的。
...
![](https://pica.zhimg.com/80/v2-a6bd81af7cf9bbda32b2cfb0e4858276_1440w.jpg?source=1940ef5c)
...
![](https://pic2.zhimg.com/50/v2-6d6a40331cd9e44bfccd27ac5a764618_720w.jpg?source=1940ef5c)
...
![](https://pica.zhimg.com/50/v2-ce1d46a1e3603b07a13789b6ece6022f_720w.jpg?source=1940ef5c)
...
![](https://pic1.zhimg.com/50/v2-c5ff4faaab9c3e13690deb86d8d17d71_720w.jpg?source=1940ef5c)
...
![](https://pic2.zhimg.com/80/v2-010a582b0c92a92044c43a2a2ea88928_1440w.jpg?source=1940ef5c)
...
![](https://pica.zhimg.com/50/v2-bb2bb039faf1234a74f479d87a0c8410_720w.jpg?source=1940ef5c)

**Java: **



![](https://pic3.zhimg.com/50/v2-55db85d27e4989303c9c396292e75eda_720w.jpg?source=1940ef5c)
...
![](https://cdn.nlark.com/yuque/0/2021/png/22382307/1639375794253-6a736aee-393c-47d0-bf8c-6222872cf390.png)
...
> 0 <= s.length <= ![image](https://g.yuque.com/gr/latex?5%20*%2010%5E4)  
...
+ 长度为 |s| - |s'|的前缀![image](https://cdn.nlark.com/yuque/__latex/ca3cc99a77092b4a870a2ed346911759.svg)；
+ 长度为 |s'|的后缀 ![image](https://g.yuque.com/gr/latex?s_2)。



即![image](https://cdn.nlark.com/yuque/__latex/fdc73740cdd21f3bfe8c1247d2ebcd37.svg)。**记 **![image](https://g.yuque.com/gr/latex?%5Chat%7Bs%7D)**为 s 的反序，那么最终得到的字符串**![image](https://g.yuque.com/gr/latex?s'%2Bs)**可以写成**![image](https://g.yuque.com/gr/latex?%5Chat%7Bs%7D_2%20%2B%20s_1%20%2B%20s_2)**的形式。**



由于 s'+s 是一个回文串，那么 s'的反序就必然与 ![image](https://g.yuque.com/gr/latex?s_2)相同，并且 ![image](https://g.yuque.com/gr/latex?s_1) 本身就是一个回文串。因此，要找到最短的 s'等价于找到最长的 ![image](https://g.yuque.com/gr/latex?s_1)。也就是说，**我们需要在字符串 s 中超出一个最长的前缀 **![image](https://g.yuque.com/gr/latex?s_1)**，它是一个回文串**。当我们找到 ![image](https://g.yuque.com/gr/latex?s_1)后，剩余的部分即为 ![image](https://g.yuque.com/gr/latex?s_2)，其反序即为 s' 。



考虑到 ![image](https://g.yuque.com/gr/latex?s_1)是一个回文串，因此 ![image](https://g.yuque.com/gr/latex?s_1%20%3D%20%5Chat%7Bs%7D_1)同样是![image](https://cdn.nlark.com/yuque/__latex/e740c53002c48e664cdd760e2a4c7539.svg) 的后缀。而![image](https://cdn.nlark.com/yuque/__latex/e740c53002c48e664cdd760e2a4c7539.svg) 可以写成![image](https://cdn.nlark.com/yuque/__latex/6c7977e6023405fa80474745ac641b5c.svg) 的形式，故而![image](https://cdn.nlark.com/yuque/__latex/5427c1ff6949355e78a6400c1cdbe9e3.svg)。从而这道题其实就是**寻找最长字符串**![image](https://cdn.nlark.com/yuque/__latex/ca3cc99a77092b4a870a2ed346911759.svg)**，使得**![image](https://cdn.nlark.com/yuque/__latex/ca3cc99a77092b4a870a2ed346911759.svg)**是即是字符串s的前缀，也是字符串**![image](https://cdn.nlark.com/yuque/__latex/a11d390449892b3fd57480bfc9b15634.svg)**的后缀。**
...
> s = "aabba"，![image](https://cdn.nlark.com/yuque/__latex/9d264908df05ef84a609be340bb50571.svg) = "aabbaabbaa"
>



这样`next[s.length() - 1] = 6`其实是超过字符串长度的，但这个时候整个字符串![image](https://g.yuque.com/gr/latex?s)并不是回文串，存粹是因为s第一个字符和最后一个字符相同，这样拼起来后 **前k个字符恰等于后k个字符的最大的k**大于字符串本身长度。所以这种情况下处理应当采用**中间插入特殊字符**方式。
