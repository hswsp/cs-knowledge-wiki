...
description: "滑动拼图游戏大家应该都玩过，下图是一个 4x4 的滑动拼图：拼图中有一个格子是空的，可以利用这个空着的格子移动其他数字。你需要通过移动这些数字，得到某个特定排列顺序，这样就算赢了。我小时候还玩过一款叫做「华容道」的益智游戏，也和滑动拼图比较类似：那么这种游戏怎么玩呢？我记得是有一些套路的，类似..."
---
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629079892455-03e79971-a233-41eb-843e-8d7a747479af.png)

拼图中有一个格子是空的，可以利用这个空着的格子移动其他数字。你需要通过移动这些数字，得到某个特定排列顺序，这样就算赢了。

我小时候还玩过一款叫做「华容道」的益智游戏，也和滑动拼图比较类似：

![image.png](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629079912180-234d4b0d-49b9-490a-a07f-97a4a4b75f3b.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629079917409-63fdc612-9cad-49ba-a518-1966dd191448.png)
...
这个��目转化成 BFS 问题是有一些技巧的，我们面临如下问题：
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629079933173-6d1147de-7d80-4e8e-9546-9df25cba42e5.png)
...
![image.png](https://cdn.nlark.com/yuque/0/2021/png/22382307/1629079944863-e155837c-33e5-46e9-932e-6ce59e7c88e5.png)
