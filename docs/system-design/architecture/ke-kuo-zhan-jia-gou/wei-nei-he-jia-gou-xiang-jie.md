...
![](https://images.spumn.eu.cc/blog/05f920ce4612be7b.png)
...
![](https://images.spumn.eu.cc/blog/fe5928222696e1bd.png)
...
![](https://images.spumn.eu.cc/blog/96f8f4e1f98b60a9.png)
...
目前最常用的规则引擎是开源的 JBoss Drools，采用 Java 语言编写，基于 Rete 算法（参考[https://en.wikipedia.org/wiki/Rete\_algorithm](https://en.wikipedia.org/wiki/Rete\_algorithm%EF%BC%89%E3%80%82Drools)）。Drools 具有下面这些优点：
...
虽然 Drools 号称简单易用，但实际上其规则语言还是和编程语言比较类似，在实际应用的时候普通业务人员面对这样的规则语言，学习成本和理解成本还是比较高的，例如下面这个样例（[https://blog.csdn.net/ouyangshixiong/article/details/46315273](https://blog.csdn.net/ouyangshixiong/article/details/46315273%EF%BC%89%EF%BC%9A)）：

![](https://images.spumn.eu.cc/blog/e72f064066ade315.png)

因此，通常情况下需要基于 Drools 进行封装，将规则配置做成可视化的操作，例如下面电商反欺诈的一个示例（[https://cloud.tencent.com/developer/article/1031839](https://cloud.tencent.com/developer/article/1031839%EF%BC%89%EF%BC%9A)）：

![](https://images.spumn.eu.cc/blog/7fde3e85eaf76cee.png)
