...
![](https://images.spumn.eu.cc/blog/e7b408aeed5b8d2d.png)
...
![](https://images.spumn.eu.cc/blog/a5ac363e2beb3e0a.png)
...
&#x20;2.抢购下单涉及到订单，库存，和商品查询。可通过请求排队来限流，超出库存的请求直接返回。 为了应对库存和商品服务可能发生的故障，可以提前对商品数据和库存数据做缓存，如果对端服务故障，本地也可以提供服务
