...
![](https://images.spumn.eu.cc/blog/03e924a4c25d5c17.png)
...
![](https://images.spumn.eu.cc/blog/812d90b8cdda82ec.png)

3 个组件组成的系统：

![](https://images.spumn.eu.cc/blog/5a5404688f42523b.png)

4 个组件组成的系统：

![](https://images.spumn.eu.cc/blog/3a0229c27f6f16c7.png)

5 个组件组成的系统：

![](https://images.spumn.eu.cc/blog/59061f3955d59218.png)
...
结构上的复杂性存在的第二个问题是，_**某个组件改动，会影响关联的所有组件**_，这些被影响的组件同样会继续递归影响更多的组件。还以上面图中 5 个组件组成的系统为例，组件 A 修改或者异常时，会影响组件 B/C/E，D 又会影响 E。这个问题会影响整个系统的开发效率，因为一旦变更涉及外部系统，需要协调各方统一进行方案评估、资源协调、上线配合。
...
![](https://images.spumn.eu.cc/blog/5a368fc244bd4a19.png)

（[http://www.abcydia.com/upload/2016/01/4-1.jpg）](http://www.abcydia.com/upload/2016/01/4-1.jpg%EF%BC%89)

如果对比 Windows 8 的架构和 Windows 1.0 的架构，就会发现它们其实是两个不同的系统了！

Android 的发展历史：

![](https://images.spumn.eu.cc/blog/3ef9777f91c6b988.png)
