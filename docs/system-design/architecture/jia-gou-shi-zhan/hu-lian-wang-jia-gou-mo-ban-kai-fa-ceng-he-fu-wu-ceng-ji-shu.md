...
在专栏第 38、39 期中，我们深入分析了互联网业务发展的一个特点：复杂度越来越高。

➡️ [jia-gou-shi-ying-gai-ru-he-pan-duan-ji-shu-yan-jin-de-fang-xiang](/system-design/architecture/jia-gou-shi-zhan/jia-gou-shi-ying-gai-ru-he-pan-duan-ji-shu-yan-jin-de-fang-xiang)

➡️ [hu-lian-wang-ji-shu-yan-jin-de-mo-shi](/system-design/architecture/jia-gou-shi-zhan/hu-lian-wang-ji-shu-yan-jin-de-mo-shi)

复杂度增加的典型现象就是系统越来越多，不同的系统由不同的小组开发。如果每个小组用不同的开发框架和技术，则会带来很多问题，典型的问题有：
...
![](https://images.spumn.eu.cc/blog/0ed071ff5575c7ff.png)
...
![](https://images.spumn.eu.cc/blog/882dae0836c0bb37.png)

* 服务总线系统（Service Bus System）

看到这个翻译，相信你可能立刻联想到计算机的总线。

没错，两者的本质也是基本类似的。相比服务名字系统，服务总线系统更进一步了：由总线系统完成调用，服务请求方都不需要直接和服务提供方交互了。

基本的设计如下：

![](https://images.spumn.eu.cc/blog/876864fb8092acca.png)

“服务名字系统”和“服务总线系统”简单对比如下表所示：

![](https://images.spumn.eu.cc/blog/224b3a42bde85636.png)
...
![](https://images.spumn.eu.cc/blog/fd65c4bd84d62ef6.png)

消息队列就是为了实现这种跨系统异步通知的中间件系统。消息队列既可以“一对一”通知，也可以“一对多”广播。以微博为例，可以清晰地看到异步通知的实现和作用，如下图所示。

![](https://images.spumn.eu.cc/blog/671060a187c17b59.png)
