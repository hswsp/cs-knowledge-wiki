...
![](https://images.spumn.eu.cc/blog/db0b8ac4d1461d03.png)
...
对于第二种生成方式，**调用方按照跟接口实现方预先商量好的算法，自己来生成幂等号**。这种实现方式的好处在于，不用像第一种方式那样调用远程接口，所以**执行效率更高**。但是，一旦需要修改幂等号的生成算法，就需要修改每个调用方的代码。
