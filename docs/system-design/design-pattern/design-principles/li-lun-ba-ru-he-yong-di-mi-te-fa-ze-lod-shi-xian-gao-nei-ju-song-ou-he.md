...
![](https://images.spumn.eu.cc/blog/777c2862d08937a1.png)
...
➡️ [li-lun-yi-dui-yu-dan-yi-zhi-ze-yuan-ze-ru-he-pan-ding-mou-ge-lei-de-zhi-ze-shi-fou-gou-dan-yi](/system-design/design-pattern/design-principles/li-lun-yi-dui-yu-dan-yi-zhi-ze-yuan-ze-ru-he-pan-ding-mou-ge-lei-de-zhi-ze-shi-fou-gou-dan-yi)
...
![](https://images.spumn.eu.cc/blog/eeb939b7305e560b.png)
...
> E**ach unit should have only limited knowledge about other units: only units “closely” related to the current unit. Or: Each unit should only talk to its friends; Don’t talk to strangers.**
...
首先，我们来看 NetworkTransporter 类。作为一个**底层网络通信类，我们希望它的功能尽可能通用，而不只是服务于下载 HTML**，所以，我们不应该直接依赖太具体的发送对象 HtmlRequest。从这一点上讲，NetworkTransporter 类的设计违背迪米特法则，依赖了不该有直接依赖关系的 HtmlRequest 类。
...
最后，我们来看下 Document 类。这个类的问题比较多，主要有三点。第一，构造函数中的 downloader.downloadHtml() 逻辑复杂，耗时长，不应该放到构造函数中，会影响代码的可测试性。代码的可测试性我们后面会讲到，这里你先知道有这回事就可以了。_第二，HtmlDownloader 对象在构造函数中通过 new 来创建，违反了基于接口而非实现编程的设计思想，也会影响到代码的可测试性。_第三，从业务含义上来讲，Document 网页文档没必要依赖 HtmlDownloader 类，违背了迪米特法则。
...
➡️ [li-lun-si-jie-kou-ge-li-yuan-ze-you-na-san-zhong-ying-yong-yuan-ze-zhong-de-jie-kou-gai-ru-he-li-jie](/system-design/design-pattern/design-principles/li-lun-si-jie-kou-ge-li-yuan-ze-you-na-san-zhong-ying-yong-yuan-ze-zhong-de-jie-kou-gai-ru-he-li-jie)
...
尽管我们还是要往 DemoClass\_1 的构造函数中，传入包含序列化和反序列化的 Serialization 实现类，但是，我们依赖的 Serializable 接口只包含序列化操作，DemoClass\_1 无法使用 Serialization 类中的反序列化接口，对反序列化操作无感知，这也就符合了迪米特法则后半部分所说的“依赖有限接口”的要求。
