...
## Fundamental notion of networking:
...
Service interface or abstraction (ByteStreams are also examples of service abstraction)
...
比如**网络诊断工具****[mtr](https://zhuanlan.zhihu.com/p/398844744)****:** `mtr lamp.mit.edu` (man mtr: [https://linux.die.net/man/8/mtr](https://linux.die.net/man/8/mtr) )
...
share a link across multiple usage/applications, and each single usage/application does not know about it. (e.g. multiple ordinary processes on the same OS)
