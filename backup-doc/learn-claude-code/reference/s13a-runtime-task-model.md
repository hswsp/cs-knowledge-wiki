...
> 来源：[https://learn.shareai.run/zh/docs/s13a-runtime-task-model/](https://learn.shareai.run/zh/docs/s13a-runtime-task-model/)
...
-   先看 [`s12-task-system.md`](./s12-task-system)，确认工作图任务在讲什么。
-   再看 [`s13-background-tasks.md`](./s13-background-tasks)，确认后台执行在讲什么。
-   如果词开始混，再回 [`glossary.md`](./glossary)。
-   如果想把字段和状态彻底对上，再对照 [`data-structures.md`](./data-structures) 和 [`entity-map.md`](./entity-map)。
