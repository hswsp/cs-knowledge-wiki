...
> 来源：[https://learn.shareai.run/zh/docs/s19a-mcp-capability-layers/](https://learn.shareai.run/zh/docs/s19a-mcp-capability-layers/)
...
-   先看 [`s19-mcp-plugin.md`](./s19-mcp-plugin)，先把 tools-first 主线走通。
-   再看 [`s02a-tool-control-plane.md`](./s02a-tool-control-plane)，确认外部能力最后怎样接回统一工具总线。
-   如果状态结构开始混，再对照 [`data-structures.md`](./data-structures)。
-   如果概念边界开始混，再回 [`glossary.md`](./glossary) 和 [`entity-map.md`](./entity-map)。
