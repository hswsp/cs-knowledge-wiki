...
> 来源：[https://learn.shareai.run/zh/docs/entity-map/](https://learn.shareai.run/zh/docs/entity-map/)
...
-   这份图先回答：一个词到底属于哪一层。
-   [`glossary.md`](./glossary) 先回答：这个词到底是什么意思。
-   [`data-structures.md`](./data-structures) 再回答：这个词落到代码里时，状态长什么样。
-   [`s13a-runtime-task-model.md`](./s13a-runtime-task-model) 专门补“工作图任务”和“运行时任务”的分层。
-   [`s19a-mcp-capability-layers.md`](./s19a-mcp-capability-layers) 专门补 MCP 平台层不是只有 tools。
...
-   先确认词属于哪一层
-   再去对应章节看机制
-   最后去 [`data-structures.md`](./data-structures) 看状态形状
