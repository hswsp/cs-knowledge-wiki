...
> 来源：[https://learn.shareai.run/zh/docs/s02b-tool-execution-runtime/](https://learn.shareai.run/zh/docs/s02b-tool-execution-runtime/)
...
-   `s02` 先教你工具为什么能被调用
-   [`s02a-tool-control-plane.md`](./s02a-tool-control-plane) 讲工具为什么会长成统一控制面
